<template>
  <div class="">
        ...
        <div class="relative overflow-hidden h-[100px]">
          <el-header class="bg-white h-[40px] w-full relative">
            <el-menu :default-active="activeMenu"
              ...
              <el-menu-item class="menu-item-custom title p-2">
                <el-popover placement="bottom-end" :visible="showAccount"
                  :show-arrow="false"
                  popper-class="text-white w-[250px] h-fit rounded-lg overflow-hidden">
                  <template #reference>
                    <icons id="icon-account" icon="mdi:user-circle" class="text-2xl text-teal-700 cursor-pointer"
    ...
    <div id="menu-horizontal" class="h-screen w-[--width-menu] bg-white
      animate
