<template>
  <div id="kajian" class="pt-[50px] translate-y-[-10px] px-0">
    ...
    <statistic-list class="bg-white/[0.9] rounded-[10px] mb-3 p-0
      ...
      ref="statisticListKajian"
      :key="'statisticListKajian'+formKey"
      :id-anggota="idAnggota"
      href-dashboard="kajian/dashboard"
      href="kajian"
      ...
      <template #header>
        <div class="text-[var(--text-color)]">Statistik Kegiatan Kajian</div>
      </template>
    </statistic-list>
    <teleport to="body">
  ...
  export default {
    ...
    methods: {
      ...
      updateChart(){
        this.$refs?.statisticListKajian?.updateChart()
      }
    },
    created: function() {
